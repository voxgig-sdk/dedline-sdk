...
// Dedline SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DedlineMakeRequest
{
    public static function call(DedlineContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DedlineResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DedlineResponse($fetched);
        } else {
