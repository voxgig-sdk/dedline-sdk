...
class DeadlineEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeadlineEntity($this->_client, $opts);
    }

    /**
     * @param Deadline|array $args Deadline data (assoc-array) to store.
     */
    ...
    /**
     * @return Deadline|array The current Deadline data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Deadline fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Deadline fields).
     */
     ...
     *
     * @param DeadlineListMatch|array|null $reqmatch Match filter (any subset
     *   of Deadline fields) as an assoc-array; DeadlineListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deadline[]|array A list of Deadline items as assoc-arrays at
