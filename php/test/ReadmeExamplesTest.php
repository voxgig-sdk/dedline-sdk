...
// Dedline SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DedlineSDK::test)
...
{
    private const SDK_CLASS = 'DedlineSDK';
    ...
    private const SDK_BASE = 'dedline_sdk';
