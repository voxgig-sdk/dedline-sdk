...
class DedlineTestRunner
{
    ...
    {
        $live = self::getenv('DEDLINE_TEST_LIVE');
        $override = self::getenv('DEDLINE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DEDLINE_TEST_EXPLAIN');
...
class_alias('DedlineTestRunner', 'Runner');
class_alias('DedlineHelpers', 'Helpers');
