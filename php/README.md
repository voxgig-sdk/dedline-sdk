...
The PHP SDK for the Dedline API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Deadline(null)->list(null, null);
...
[$result, $err] = $client->Dedline(null)->load(
    ["id" => "test01"], null
);
