...
class DedlineRbacFeature extends DedlineBaseFeature
{
    ...
    private function _required(DedlineContext $ctx): ?string
    {
    ...
    private function _reject(DedlineContext $ctx, string $required): void
    {
    ...
    private function _track(DedlineContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
