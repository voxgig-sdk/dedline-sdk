...
// Dedline SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DedlineTestFeature extends DedlineBaseFeature
{
    ...
    public function init(DedlineContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DedlineContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DedlineContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DedlineContext $ctx, $op, $args): array
    {
