...
class DedlineCacheFeature extends DedlineBaseFeature
{
    ...
    private function _through(DedlineContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
