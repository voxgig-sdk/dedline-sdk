...
class DedlineStreamingFeature extends DedlineBaseFeature
{
    ...
    private function _iterate(DedlineResult $result): \Generator
    {
    ...
    private function _streamable(DedlineContext $ctx): bool
    {
