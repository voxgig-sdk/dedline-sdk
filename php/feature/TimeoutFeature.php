...
class DedlineTimeoutFeature extends DedlineBaseFeature
{
    ...
    private function _with_timeout(DedlineContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DedlineContext $_ctx, float $ms): void
    {
        $client = $this->client;
