...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = DedlineOmni.make_runner(TEST_JSON_FILE, DedlineSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : DedlineOmni.errify(err)
    end
