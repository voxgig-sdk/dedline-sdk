...
class DedlineGraphql
{
    ...
    // equivalent.
    public static function body(DedlineContext $ctx): mixed
    {
    ...
    public static function errors(DedlineContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
