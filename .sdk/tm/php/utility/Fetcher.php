...
// Dedline SDK utility: fetcher

class DedlineFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DedlineSDK/1.0)';
    ...
    public static function call(DedlineContext $ctx, string $fullurl, array $fetchdef): array
    {
