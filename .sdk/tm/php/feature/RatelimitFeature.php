...
class DedlineRatelimitFeature extends DedlineBaseFeature
{
    ...
    private function _acquire(DedlineContext $ctx): void
    {
    ...
    private function _track(DedlineContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
