...
// Dedline SDK clienttrack feature
...
class DedlineClienttrackFeature extends DedlineBaseFeature
{
    ...
    public function PostConstruct(DedlineContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Dedline-SDK';
