...
class DedlineProxyFeature extends DedlineBaseFeature
{
    ...
    public function init(DedlineContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DedlineContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
