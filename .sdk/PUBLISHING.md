...
|---|---|---|
| `ts/` | @voxgig-sdk/dedline-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dedline-sdk \
      --repository voxgig-sdk/dedline-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dedline-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dedline-sdk --id=<id>` removes it.
