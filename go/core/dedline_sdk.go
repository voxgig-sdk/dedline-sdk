...
func (sdk *DedlineSDK) OptionsMap() map[string]any {
...
func (sdk *DedlineSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DedlineSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DedlineSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DedlineSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DedlineSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DedlineSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DedlineSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DedlineSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DedlineSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DedlineSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
