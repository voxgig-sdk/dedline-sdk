...
type RegistrationFeatureEntity struct {
	name    string
...
func NewRegistrationFeatureEntity(client *core.DedlineSDK, entopts map[string]any) *RegistrationFeatureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegistrationFeatureEntity) GetName() string { return e.name }
...
func (e *RegistrationFeatureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegistrationFeatureEntity) Deleted() bool {
	return e.deleted
}


func (e *RegistrationFeatureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegistrationFeatureEntity(e.client, opts)
}

func (e *RegistrationFeatureEntity) Data(args ...any) any {
...
func (e *RegistrationFeatureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *RegistrationFeatureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegistrationFeatureEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *RegistrationFeatureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RegistrationFeatureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegistrationFeatureEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegistrationFeatureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
