...
func NewDeadlineEntity(client *core.DedlineSDK, entopts map[string]any) *DeadlineEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeadlineEntity) GetName() string { return e.name }
...
func (e *DeadlineEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeadlineEntity) Deleted() bool {
	return e.deleted
}


func (e *DeadlineEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeadlineEntity(e.client, opts)
}

func (e *DeadlineEntity) Data(args ...any) any {
...
func (e *DeadlineEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Deadline; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeadlineEntity) DataTyped(data ...Deadline) Deadline {
	if len(data) > 0 {
		return typedFrom[Deadline](e.Data(asMap(data[0])))
	}
	return typedFrom[Deadline](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Deadline (all fields
// optional at the wire level).
func (e *DeadlineEntity) MatchTyped(match ...Deadline) Deadline {
	if len(match) > 0 {
		return typedFrom[Deadline](e.Match(asMap(match[0])))
	}
	return typedFrom[Deadline](e.Match())
}
...
func (e *DeadlineEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeadlineEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DeadlineEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeadlineListMatch and returns []Deadline. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeadlineEntity) ListTyped(reqmatch DeadlineListMatch, ctrl map[string]any) ([]Deadline, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Deadline](res), nil
}



func (e *DeadlineEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeadlineEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeadlineEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeadlineEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
