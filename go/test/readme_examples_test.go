...
const testSeed = `map[string]any{"entity": map[string]any{"deadline": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "registration_feature": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "state": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
