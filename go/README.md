...
## Install
```bash
go get github.com/voxgig-sdk/dedline-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/dedline-sdk=../path/to/github.com/voxgig-sdk/dedline-sdk
```
...
```
github.com/voxgig-sdk/dedline-sdk/
...
The root package (`github.com/voxgig-sdk/dedline-sdk`) re-exports everything needed
