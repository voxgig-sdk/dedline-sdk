...
describe("RegistrationFeatureDirect", function()
  it("should direct-list-registration_feature", function()
    local setup = registration_feature_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-registration_feature", setup.live and "live" or "unit")
...
function registration_feature_direct_setup(mockres)
