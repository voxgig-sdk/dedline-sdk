...
describe("DeadlineDirect", function()
  it("should direct-list-deadline", function()
    local setup = deadline_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-deadline", setup.live and "live" or "unit")
...
function deadline_direct_setup(mockres)
