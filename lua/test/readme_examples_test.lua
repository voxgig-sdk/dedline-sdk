...
-- data to return.
local TEST_SEED = '{ entity = { ["deadline"] = { ["test01"] = { id = "test01" } }, ["registration_feature"] = { ["test01"] = { id = "test01" } }, ["stat"] = { ["test01"] = { id = "test01" } }, ["state"] = { ["test01"] = { id = "test01" } } } }'
