...
local RegistrationFeatureEntity = {}
RegistrationFeatureEntity.__index = RegistrationFeatureEntity


function RegistrationFeatureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegistrationFeatureEntity)
  self._name = "registration_feature"
  self._client = client
...
function RegistrationFeatureEntity:get_name()
  return self._name
end


function RegistrationFeatureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RegistrationFeatureEntity.new(self._client, opts)
end
...
function RegistrationFeatureEntity:mark_deleted()
  self._deleted = true
end


function RegistrationFeatureEntity:deleted()
  return true == self._deleted
end


function RegistrationFeatureEntity:data_set(args)
  if args ~= nil then
...
function RegistrationFeatureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegistrationFeatureEntity:match_set(args)
  if args ~= nil then
...
function RegistrationFeatureEntity:match_get()
...
function RegistrationFeatureEntity:stream(action, args, callopts)
...
function RegistrationFeatureEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RegistrationFeatureEntity
