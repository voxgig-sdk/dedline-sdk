...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dedline` | `npm install @voxgig-sdk/dedline` |
| Python | `voxgig-sdk-dedline` | `pip install voxgig-sdk-dedline` |
| PHP | `voxgig-sdk/dedline` | `composer require voxgig-sdk/dedline` |
| Golang | `github.com/voxgig-sdk/dedline-sdk/go` | `go get github.com/voxgig-sdk/dedline-sdk/go` |
| Ruby | `voxgig-sdk-dedline` | `gem install voxgig-sdk-dedline` |
| Lua | `voxgig-sdk-dedline` | `luarocks install voxgig-sdk-dedline` |
