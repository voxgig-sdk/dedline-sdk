# Dedline SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DedlineSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DedlineSDK(...) and DedlineSDK.test(...) become
#      DedlineSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dedline_sdk"
_SDK_CLASS = "DedlineSDK"
