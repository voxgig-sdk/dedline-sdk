...
from dedline_sdk.core.response import DedlineResponse
from dedline_sdk.core.operation import DedlineOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DedlineSDK.test(None, None)
        ...
        class TestInitFeature(DedlineBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DedlineBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DedlineSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DedlineSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DedlineSDK.test(None, setup_opts)
