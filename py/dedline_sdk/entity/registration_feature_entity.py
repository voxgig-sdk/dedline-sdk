...
from dedline_sdk.dedline_types import (
    RegistrationFeature,
    RegistrationFeatureListMatch,
)
...
class RegistrationFeatureEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegistrationFeatureEntity(self._client, opts)
    ...
    def data_get(self) -> RegistrationFeature:
    ...
    def match_get(self) -> RegistrationFeature:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RegistrationFeature]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RegistrationFeature().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
