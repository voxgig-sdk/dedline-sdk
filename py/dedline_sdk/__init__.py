...
from dedline_sdk.utility import register

# Load features
from dedline_sdk.feature.base_feature import DedlineBaseFeature
from dedline_sdk.features import _has_feature, _make_feature
...
class DedlineSDK:
    ...
    def get_utility(self):
        return DedlineUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DedlineSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Deadline(self, data=None) -> "DeadlineEntity":
        ...
        from dedline_sdk.entity.deadline_entity import DeadlineEntity
    ...
    def RegistrationFeature(self, data=None) -> "RegistrationFeatureEntity":
        ...
        from dedline_sdk.entity.registration_feature_entity import RegistrationFeatureEntity
