...
from dedline_sdk.core.helpers import get_ctx_prop, to_map
...
class DedlineContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DedlineResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DedlineError(code, msg, self)
