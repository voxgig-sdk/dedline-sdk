...
| --- | --- | --- | --- |
| Deadline | `list` | `GET /upcoming.json` | See reference |
| RegistrationFeature | `list` | `GET /lastMinuteAccepted.json` | See reference |
| RegistrationFeature | `list` | `GET /onlineNotAccepted.json` | See reference |
| Stat | `load` | `GET /stats.json` | See reference |
| State | `list` | `GET /states.json` | See reference |
| State | `load` | `GET /states/{stateAbbreviation}.json` | See reference |

## Connect to the API

- Production server: `https://dedline-api.netlify.app`
...
- `dedline_list`: List records for an entity. Supported entities: `deadline`, `registration_feature`, `state`.
- `dedline_load`: Load one record for an entity. Supported entities: `stat`, `state`.
