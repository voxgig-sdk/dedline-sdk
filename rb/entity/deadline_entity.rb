...
class DeadlineEntity
  ...
  def make
    opts = @_entopts.dup
    DeadlineEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [DeadlineListMatch, Hash, nil] match filter (any subset of
  #   Deadline fields); defaults to nil, treated as an empty match that lists all.
