...
module DedlineTestRunner
  ...
  def self.env_override(m)
    live = getenv("DEDLINE_TEST_LIVE")
    override = getenv("DEDLINE_TEST_OVERRIDE")
    ...
    explain = getenv("DEDLINE_TEST_EXPLAIN")
    m["DEDLINE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DedlineTestRunner
Helpers = DedlineHelpers
Vs = VoxgigStruct
