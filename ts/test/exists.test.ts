...
describe('exists', async () => {
  ...
  //
  // DedlineSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof DedlineSDK, true,
      'DedlineSDK.test() must return a client synchronously')
  })
