...
function envOverride(m) {
    if ('TRUE' === process.env.DEDLINE_TEST_LIVE ||
        'TRUE' === process.env.DEDLINE_TEST_OVERRIDE) {
    ...
    m.DEDLINE_TEST_EXPLAIN = process.env.DEDLINE_TEST_EXPLAIN || m.DEDLINE_TEST_EXPLAIN;
    return m;
}
