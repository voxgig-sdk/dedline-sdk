...
(0, node_test_1.describe)('RegistrationFeatureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-registration_feature', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-registration_feature', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.DEDLINE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DedlineSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DEDLINE_TEST_REGISTRATION_FEATURE_ENTID'];
    ...
    const client = new __1.DedlineSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RegistrationFeatureDirect.test.js.map