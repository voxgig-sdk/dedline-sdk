...
(0, node_test_1.describe)('DeadlineDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-deadline', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-deadline', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DEDLINE_TEST_DEADLINE_ENTID'];
...
//# sourceMappingURL=DeadlineDirect.test.js.map