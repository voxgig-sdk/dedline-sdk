...
func registerSDKWords(r *eng.Registry, client *sdk.DedlineSDK) {
...
func runOp(client *sdk.DedlineSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
